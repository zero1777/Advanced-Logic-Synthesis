...
s4:   glp_add_rows(lp, 4);
s5:   glp_set_row_name(lp, 1, "p");
s6:   glp_set_row_bnds(lp, 1, GLP_FX, 0.0, 0.0);
s7:   glp_set_row_name(lp, 2, "q");
s8:   glp_set_row_bnds(lp, 2, GLP_FX, 0.0, 0.0);
s9:   glp_set_row_name(lp, 3, "r");
s10:  glp_set_row_bnds(lp, 3, GLP_FX, 0.0, 0.0);
      glp_set_row_name(lp, 4, "s");
      glp_set_row_bnds(lp, 4, GLP_FX, 1.0, 1.0);
s11:  glp_add_cols(lp, 3);
s12:  glp_set_col_name(lp, 1, "x1");
s13:  glp_set_col_bnds(lp, 1, GLP_DB, 0.0, 1.0);
s14:  glp_set_obj_coef(lp, 1, 1.0);
s15:  glp_set_col_name(lp, 2, "x2");
s16:  glp_set_col_bnds(lp, 2, GLP_DB, 0.0, 1.0);
s17:  glp_set_obj_coef(lp, 2, 1.0);
s18:  glp_set_col_name(lp, 3, "x3");
s19:  glp_set_col_bnds(lp, 3, GLP_DB, 0.0, 1.0);
s20:  glp_set_obj_coef(lp, 3, 1.0);
s21:  ia[1] = 1, ja[1] = 1, ar[1] =  -1.0; /* a[1,1] =  1 */
s22:  ia[2] = 1, ja[2] = 2, ar[2] =  1.0; /* a[1,2] =  1 */
s23:  ia[3] = 1, ja[3] = 3, ar[3] =  0.0; /* a[1,3] =  1 */
s24:  ia[4] = 2, ja[4] = 1, ar[4] = 0.25; /* a[2,1] = 10 */
s25:  ia[5] = 2, ja[5] = 2, ar[5] =  -1.0; /* a[3,1] =  2 */
s26:  ia[6] = 2, ja[6] = 3, ar[6] =  1.0; /* a[2,2] =  4 */
s27:  ia[7] = 3, ja[7] = 1, ar[7] =  0.75; /* a[3,2] =  2 */
s28:  ia[8] = 3, ja[8] = 2, ar[8] =  0.0; /* a[2,3] =  5 */
s38:  ia[9] = 3, ja[9] = 3, ar[9] =  -1; /* a[3,3] =  6 */
s39:  ia[10] = 4, ja[10] = 1, ar[10] =  1.0; /* a[3,3] =  6 */
s40:  ia[11] = 4, ja[11] = 2, ar[11] =  1.0; /* a[3,3] =  6 */
s41:  ia[12] = 4, ja[12] = 3, ar[12] =  1.0; /* a[3,3] =  6 */
s30:  glp_load_matrix(lp, 12, ia, ja, ar);
