 ...
 *
 * $Source: /vol/opua/opua2/sis/sis-1.2/common/src/sis/command/RCS/filec.c,v $
 * $Author: sis $
 * $Revision: 1.8 $
...
#if defined(hpux) || defined(SYSTYPE_BSD43) || defined(SYSTYPE_SYSV) || defined(linux)
char *
...
#else
	    while ((dp = readdir(dir)) != NIL(struct direct)) {
#endif
